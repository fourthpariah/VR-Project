...
IL2CPP_EXTERN_C String_t* _stringLiteral6A6F132E1DE3A2BD49F23CCC588A7B872EAF5E45;
...
struct ObjectController_tC7C3CD5CDC9519FAA82AEE4489D5319439D254BC  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
	...
	// System.Boolean ObjectController::isGrabbed
...
// System.Void ObjectController::GrabObject()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ObjectController_GrabObject_m0B48F91E03534C819782E8F23A0D92FB067198A1 (ObjectController_tC7C3CD5CDC9519FAA82AEE4489D5319439D254BC* __this, const RuntimeMethod* method) ;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CameraPointer_Update_mF19D284A593E4627CD4F22A58C11FB87B6627FF4 (CameraPointer_t9BABD11B0AABF9D79F1E27604DF9018F1386C024* __this, const RuntimeMethod* method) 
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		...
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteral6A6F132E1DE3A2BD49F23CCC588A7B872EAF5E45);
...
IL_0094:
	...
	{
		// _gazedAtObject?.SendMessage("OnPointerHeld");
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_18 = __this->____gazedAtObject_5;
...
IL_00b0:
	{
		NullCheck(G_B13_0);
		GameObject_SendMessage_m65848D6A8F999FACBC1C21B7303660B7AFF6674E(G_B13_0, _stringLiteral6A6F132E1DE3A2BD49F23CCC588A7B872EAF5E45, NULL);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CardboardStartup_Start_m35E3138C09D62411C4C8503DD4D47DA2AF9BF6E2 (CardboardStartup_t7D6D696AD513DC97C444D91AC5D0979A253FED41* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		// Google.XR.Cardboard.Api.MinTriggerHeldPressedTime = 0.5;
		il2cpp_codegen_runtime_class_init_inline(Api_t145FCB8AD359667011C398E3BE4F2962C25C363D_il2cpp_TypeInfo_var);
		Api_set_MinTriggerHeldPressedTime_m59FE93319C0A2344C585E2EFC56FDB038AF65DFC((0.5), NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ObjectController_TeleportRandomly_m45F23374832369044CBD4F60F4F976D33C97C181 (ObjectController_tC7C3CD5CDC9519FAA82AEE4489D5319439D254BC* __this, const RuntimeMethod* method) 
{
	...
	int32_t V_1 = 0;
	{
		...
		// transform.parent.GetChild(sibIdx).localPosition = transform.parent.localPosition;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ObjectController_GrabObject_m0B48F91E03534C819782E8F23A0D92FB067198A1 (ObjectController_tC7C3CD5CDC9519FAA82AEE4489D5319439D254BC* __this, const RuntimeMethod* method) 
{
	...
	memset((&V_1), 0, sizeof(V_1));
	{
		// float dist = Vector3.Distance(Camera.main.transform.position, transform.parent.localPosition);
		...
		V_0 = L_6;
		// Vector3 camPos = Camera.main.transform.position + Camera.main.transform.forward * dist;
		...
		V_1 = L_15;
		// GetComponent<Rigidbody>().position = camPos;
		...
		NullCheck(L_16);
		Rigidbody_set_position_mA15BE12B8D82220E8CA90A0F0CBFB206FE81B41C(L_16, L_17, NULL);
		// }
		return;
	}
}
...
// System.Void ObjectController::OnPointerHeld()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ObjectController_OnPointerHeld_mECBA6A6D4F21D71135F4DC553D161BC6118E83BD (ObjectController_tC7C3CD5CDC9519FAA82AEE4489D5319439D254BC* __this, const RuntimeMethod* method) 
{
	{
		// isGrabbed = true;
		__this->___isGrabbed_13 = (bool)1;
		// GrabObject();
		ObjectController_GrabObject_m0B48F91E03534C819782E8F23A0D92FB067198A1(__this, NULL);
		// isGrabbed = false;
		__this->___isGrabbed_13 = (bool)0;
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ObjectController_Update_m265D4C1E6835E4BFBAFCFBB811B6F06808E89320 (ObjectController_tC7C3CD5CDC9519FAA82AEE4489D5319439D254BC* __this, const RuntimeMethod* method) 
{
	...
	{
		// if(isGrabbed)
		bool L_0 = __this->___isGrabbed_13;
		if (!L_0)
		{
			goto IL_0015;
		}
